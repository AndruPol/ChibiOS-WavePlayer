...
/*
 * Setup for ST STM32L152RBT6 MCU.
 */

/*
 * Board identifier.
 */
#define BOARD_MY_STM32L152RBT6
#define BOARD_NAME                  "MY STM32L152RBT6 BOARD"
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_400K(GPIOA_PIN0) |        	\
                                     ...
                                     PIN_OSPEED_400K(GPIOA_USB_DM) |        \
                                     PIN_OSPEED_400K(GPIOA_USB_DP) |        \
                                     PIN_OSPEED_40M(GPIOA_SWDIO) |       	\
                                     PIN_OSPEED_40M(GPIOA_SWCLK) |       	\
                                     PIN_OSPEED_400K(GPIOA_PIN15))
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_400K(GPIOB_PIN0) |          \
                                     ...
                                     PIN_OSPEED_400K(GPIOB_PIN2) |          \
                                     PIN_OSPEED_40M(GPIOB_TRACESWO) |       \
                                     PIN_OSPEED_400K(GPIOB_PIN4) |      	\
